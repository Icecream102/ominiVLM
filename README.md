...
> Prediction texts are truncated for display; full outputs are in `results/official_coco/sft_full_vlm/predictions_{correct,black,shuffled}.jsonl` (regenerated by `eval_vlm_benchmark.py`, seed 42, first 6 samples).
